...
<html>
	...
	<body>
		...
		<div class="container">
			<table style="width:60%; margin-top: 10px; margin-left:2%">
				...
				<td>
					...
					<div>
						<form  style="display:inline-block" action="" method="post">
							<button type="submit" style="width:40%; height: 100%; border:none; background-color:white; color:#0099ff; float:left" name="editButtom"><b>Edit<b></button>
						</form>
						<form style="display:inline-block" action="" method="post">
							<button type="submit" style="float:right; width:40%; height: 100%; border:none; background-color:white; color:#009933" name="doneButtom"><b>Done<b></button>
						</form>
					</div>
				</td>
			</table>
